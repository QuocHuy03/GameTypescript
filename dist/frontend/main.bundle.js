            ...
            if (checkMatchedFilter.length < 2) {
                ...
                setTimeout(() => openedItems.forEach(item => {
                    if (item.imageElement) {
                        item.imageElement.className = 'invisible';
                        item.imageElement.style.width = '100px';
                        item.status = _models_GameItem__WEBPACK_IMPORTED_MODULE_2__.GameItemStatus.Close;
                        item.isMatched = false;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkass_typescript"] = self["webpackChunkass_typescript"] || [];
